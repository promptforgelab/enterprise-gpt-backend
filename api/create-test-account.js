...
const MANAGER_ID = process.env.GADS_MANAGER_ID; // 👈 MCC ID, no dashes
...
module.exports = async (req, res) => {
  try {
    ...
    const client = new GoogleAdsApi({
      ...
      login_customer_id: MANAGER_ID, // login as MCC
    });
    ...
    const result = await mcc.customerService.createCustomerClient({
      customerClient: {
    ...
    return res
      .status(500)
      .json({ error: "Failed to create test account", details: err.message });
  }
};
